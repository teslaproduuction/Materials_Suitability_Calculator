...
def calculate_K1(lambda_value, sigma_B, alpha, E):
    ...
    return scientific_notation(result), result
...
def add_to_array(*args):
    ...
    for set_values in sets_of_values:
        ...
        K1, K1E = calculate_K1(values_dict["lambda"][-1], values_dict["sigma_B"][-1], values_dict["alpha"][-1],
                          values_dict["E"][-1])
        ...
        K3, K3E = calculate_K3(values_dict["lambda"][-1], values_dict["KSU"][-1], values_dict["alpha"][-1],
                          values_dict["E"][-1])
        K_values["K3"].append(K3)
        K_values2["K3"].append(K3E)
        K4, K4E = calculate_K4(values_dict["lambda"][-1], values_dict["c"][-1], values_dict["alpha"][-1],
                          values_dict["rho"][-1])
        K_values["K4"].append(K4)
        K_values2["K4"].append(K4E)
        K5, K5E = calculate_K5(values_dict["lambda"][-1], values_dict["c"][-1], values_dict["rho"][-1],
                          values_dict["alpha"][-1], values_dict["E"][-1])
        K_values["K5"].append(K5)
        K_values2["K5"].append(K5E)
        K6, K6E = calculate_K6(values_dict["sigma_B"][-1], values_dict["mu"][-1], values_dict["alpha"][-1],
                          values_dict["E"][-1])
        K_values["K6"].append(K6)
        K_values2["K6"].append(K6E)
        K7, K7E = calculate_K7(values_dict["lambda"][-1], values_dict["c"][-1], values_dict["rho"][-1],
                          values_dict["sigma_B"][-1], values_dict["mu"][-1], values_dict["alpha"][-1],
                          values_dict["E"][-1])
        K_values["K7"].append(K7)
        K_values2["K7"].append(K7E)
        K8, K8E = calculate_K8(values_dict["sigma_B"][-1], values_dict["HRC"][-1], values_dict["E"][-1])
        K_values["K8"].append(K8)
        K_values2["K8"].append(K8E)
        K9, K9E = calculate_K9(values_dict["sigma_0_2"][-1], values_dict["tau"][-1], values_dict["alpha"][-1])
        K_values["K9"].append(K9)
        K_values2["K9"].append(K9E)
        K10, K10E = calculate_K10(values_dict["t_k"][-1], values_dict["t_f"][-1], values_dict["alpha"][-1],
                            values_dict["E"][-1], values_dict["mu"][-1], values_dict["sigma_0_2"][-1])
        K_values["K10"].append(K10)
        K_values2["K10"].append(K10E)
        K11, K11E = calculate_K11(values_dict["delta"][-1], values_dict["alpha"][-1], values_dict["mu"][-1],
                            values_dict["t_k"][-1], values_dict["t_f"][-1], values_dict["sigma_0_2"][-1],
                            values_dict["E"][-1])
        K_values["K11"].append(K11)
        K_values2["K11"].append(K11E)
        K12, K12E = calculate_K12(values_dict["KSU"][-1], values_dict["sigma_0_2"][-1], values_dict["alpha"][-1],
                            values_dict["t_k"][-1], values_dict["E"][-1])
        K_values["K12"].append(K12)
        K_values2["K12"].append(K12E)
        K13, K13E = calculate_K13(values_dict["sigma_B"][-1], values_dict["psi"][-1], values_dict["sigma_0_2"][-1],
                            values_dict["alpha"][-1], values_dict["t_k"][-1], values_dict["t_f"][-1])
        K_values["K13"].append(K13)
        K_values2["K13"].append(K13E)
        K14, K14E = calculate_K14(values_dict["sigma_B"][-1], values_dict["delta"][-1], values_dict["psi"][-1],
        ...
        K15, K15E = calculate_K15(values_dict["sigma_B"][-1], values_dict["alpha"][-1], values_dict["t_k"][-1],
                            values_dict["t_f"][-1], values_dict["mu"][-1], values_dict["sigma_0_2"][-1],
                            values_dict["E"][-1])
        K_values["K15"].append(K15)
        K_values2["K15"].append(K15E)
        K16, K16E = calculate_K16(values_dict["psi"][-1], values_dict["alpha"][-1], values_dict["t_k"][-1],
                            values_dict["t_f"][-1], values_dict["mu"][-1], values_dict["sigma_0_2"][-1],
                            values_dict["E"][-1])
